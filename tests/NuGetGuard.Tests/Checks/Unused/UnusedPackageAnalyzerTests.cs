...
namespace NuGetGuard.Tests.Checks.Unused;
...
public sealed class UnusedPackageAnalyzerTests : IDisposable
{
    ...
    {
        var solution = BuildSolution("using NuGetGuard.Discovery;\n\nclass Program { static void Main() { } }");
    ...
    {
        var solution = BuildSolution("class Program { static void Main() { var x = NuGetGuard.Checks.Licenses.LicenseRisk.Permissive; } }");
    ...
    public void Analyze_GlobalUsingInProjectFile_CountsAsUsed()
    {
        var solution = BuildSolution(
            ...
            <Project ToolsVersion="15.0">
              <ItemGroup>
                <Using Include="NuGetGuard.Discovery" />
              </ItemGroup>
            </Project>
            """);
