...
using NuGetGuard.Infrastructure.DotNet.Models;
using NuGetGuard.Infrastructure.DotNet;
using NuGetGuard.Infrastructure.NuGetApi;

namespace NuGetGuard.Checks.Outdated;
...
/// </summary>
public sealed class OutdatedCheck(NuGetClient nuget)
{
